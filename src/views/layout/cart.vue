    ...
    <div class="cart-box" v-if="isLogin && cartList.length > 0">
        ...
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <CountBox :value="item.goods_num" @input="e => changeCount(e, item.goods_id, item.goods_sku_id)"></CountBox>
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-else @click="handleDel" class="delete" :class="{ disabled: selCount === 0 }" >删除</div>({{ selCount }})
        </div>
      </div>
    </div>
...
export default {
  ...
  watch: {
    isEdit (value) {
      // 如果处于“编辑状态”，则全选状态为“不勾选”，如果处于“非编辑（即结算）状态”，则全选状态为“勾选”
      if (value) {
